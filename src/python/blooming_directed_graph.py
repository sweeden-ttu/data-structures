"""
Blooming-directed-graph: each repository under ~/projects (except data-structures) is a node.

A blooming-directed-graph is a directed graph whose nodes are repositories and edges are directed
(e.g. repo -> github_actions). Distinct from a generic "blooming graph". Interacts with GitHub Actions API.
...
class BloomingDirectedGraph:
    """Blooming-directed-graph: directed graph of repos as nodes; edges to github_actions."""
